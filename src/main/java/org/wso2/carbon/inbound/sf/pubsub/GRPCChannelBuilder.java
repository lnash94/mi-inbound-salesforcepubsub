...
//        GRPCChannelBuilder.tlsEnabled = Boolean.parseBoolean(tlsEnabled);
//    }
...
//
//            com.salesforce.eventbus.protobuf.PubSubGrpc.PubSubBlockingStub stub;
//            com.salesforce.eventbus.protobuf.PubSubGrpc.PubSubStub asyncStub;
...
//                asyncStub = com.salesforce.eventbus.protobuf.PubSubGrpc.newStub(channel).withCallCredentials(basicAuthCredential);
...
//                asyncStub = com.salesforce.eventbus.protobuf.PubSubGrpc.newStub(channel).withCallCredentials(tokenCredential);
//            } else {
//                stub = com.salesforce.eventbus.protobuf.PubSubGrpc.newBlockingStub(channel);
//                asyncStub = com.salesforce.eventbus.protobuf.PubSubGrpc.newStub(channel);
//            }
//            messageContext.setProperty("stub", stub);
//            messageContext.setProperty("asyncStub", asyncStub);
//
